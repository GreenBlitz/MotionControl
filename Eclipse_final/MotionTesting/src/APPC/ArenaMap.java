...
public class ArenaMap {
	...
	public ArenaMap(double acc, double arenaX, double arenaY) {
		m_mapAccuracy = acc;
		m_map = new LinkedList[(int) (arenaX / acc)][(int) (arenaY / acc)];
	...
	private Orientation2D closestPoint(Orientation2D loc, double radius){
		Orientation2D ret = findClosest(pointsInRange(loc, radius, 2*radius), loc);
