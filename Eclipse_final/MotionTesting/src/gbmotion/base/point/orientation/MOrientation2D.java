...
public class MOrientation2D extends Orientation2D {
	...
	public IPoint2D moveBy(double x, double y) {
		IOrientation2D rotated = (IOrientation2D) Orientation2D.immutable(this).rotate(-getDirection(),
				DirectionEffect.IGNORED);
		rotated = (IOrientation2D) Orientation2D
				.immutable(rotated.getX() + x, rotated.getY() + y, rotated.getDirection())
