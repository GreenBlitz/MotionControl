...
public class RobotMap {
	...
	//Chassis motor ports
	public static final int CHASSIS_FRONT_LEFT_MOTOR_PORT = 5,
							CHASSIS_REAR_LEFT_MOTOR_PORT = 4,
	...
	public static final int CATAPULT_MOTOR_PORT = 0,
							CATAPULT_MIRCOSWITCH_PORT = 0;
	
	//Intake ports
	public static final int INTAKE_RIGHT_MOTOR_PORT = 0,
							INTAKE_LEFT_MOTOR_PORT = 0,
							INTAKE_MIRCOSWITCH_PORT = 0;
	
	//Intake pitcher ports
	public static final int INTAKE_PITCHER_MOTOR_PORT = 0,
							INTAKE_POTENTIOMETER_PORT = 0;
	
	//Pitcher state values
	public static final int INTAKE_PITCHER_COLLECT_VALUE = 0,
							INTAKE_PITCHER_DEFAULT_VALUE = 0,
							INTAKE_PITCHER_SWITCH_VALUE = 0,
							INTAKE_PITCHER_SCALE_VALUE = 0;
}
