...
public class RobotMap {
	...
	// Chassis motor ports
	public static final int CHASSIS_FRONT_LEFT_MOTOR_PORT = 0, CHASSIS_REAR_LEFT_MOTOR_PORT = 1,
			CHASSIS_FRONT_RIGHT_MOTOR_PORT = 2, CHASSIS_REAR_RIGHT_MOTOR_PORT = 3;
	// Chassis encoder ports
	public static final int CHASSIS_LEFT_ENCODER_PORT_A = 2, CHASSIS_LEFT_ENCODER_PORT_B = 3,
			CHASSIS_RIGHT_ENCODER_PORT_A = 0, CHASSIS_RIGHT_ENCODER_PORT_B = 1;
