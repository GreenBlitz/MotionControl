...
import org.greenblitz.motion.fuzzylogic.*;
...
public class FuzzyPID extends PIDController{
    ...
    List<FuzzyValue> types = Arrays.asList(new FuzzyValue[]{NB,NM,NS,ZO,PS,PM,PB});

    //e,ce output
    List<Rule> KdRules = Arrays.asList(new Rule[]{
            new Rule(new FuzzyValue[]{NB,NB},PB),
    ...
    List<Rule> KpRules = Arrays.asList(new Rule[]{
            new Rule(new FuzzyValue[]{NB,NB},ZO),
