...
public class ArcadeDriveByJoystick extends Command {
    ...
    private RemoteCSVTarget logger = RemoteCSVTarget.initTarget("vision distance", "t", "distance");
    ...
    protected void execute() {
        ...
        logger.report(System.currentTimeMillis(), OI.getInstance().getHatchDistance());
    }
